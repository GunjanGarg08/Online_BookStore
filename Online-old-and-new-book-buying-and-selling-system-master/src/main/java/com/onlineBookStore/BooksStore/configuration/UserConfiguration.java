...
/**
 * Security configuration - registers UserDetailsService and password encoder.
 */
@Configuration
@EnableWebSecurity
public class UserConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public UserDetailsService getUserDetailsService() {
        return new UserCustomConfigService(); // ensure this class is @Service (see below)
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .and()
                .csrf().disable();
        // inside configure(HttpSecurity http)
//        http.csrf().disable();
    }
}
