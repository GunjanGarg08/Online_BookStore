...
//	}
    ...
    @PostMapping("/do_paymentOfStore")
    @ResponseBody
    public String saveStore(@RequestBody Map<String, Object> map) {
        JSONObject options = new JSONObject();
        options.put("status", "success");
        options.put("msg", "Payment bypassed for demo");
        return options.toString();
    }

    @PostMapping("/do_paymentOfBook")
    @ResponseBody
    public String paymentOfBook(@RequestBody Map<String, Object> map) {
        JSONObject options = new JSONObject();
        options.put("status", "success");
        options.put("msg", "Payment bypassed for demo");
        return options.toString();
